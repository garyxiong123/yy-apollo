...
import com.ctrip.framework.apollo.repository.AppRepository;
...
//    appAPI.createApp(env, appDTO);
  ...
  public App deleteAppInLocal(String appId) {
    ...
    //this operator is passed to com.ctrip.framework.apollo.listener.DeletionListener.onAppDeletionEvent
    managedApp.setDataChangeLastModifiedBy(operator);

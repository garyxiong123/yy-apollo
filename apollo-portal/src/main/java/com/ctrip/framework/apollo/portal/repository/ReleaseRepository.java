...
public interface ReleaseRepository extends PagingAndSortingRepository<Release, Long> {
  ...
  Release findFirstByAppIdAndClusterNameAndNamespaceNameAndEnvAndIsAbandonedFalseOrderByIdDesc(@Param("appId") String appId, @Param("clusterName") String clusterName,
                                                                                         @Param("namespaceName") String namespaceName, @Param("env") String env);

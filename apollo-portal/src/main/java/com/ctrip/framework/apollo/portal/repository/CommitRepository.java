...
public interface CommitRepository extends PagingAndSortingRepository<Commit, Long> {
  ...
  List<Commit> findByAppIdAndClusterNameAndNamespaceNameAndEnvOrderByIdDesc(String appId, String clusterName,
                                                                            String namespaceName, String env, Pageable pageable);
